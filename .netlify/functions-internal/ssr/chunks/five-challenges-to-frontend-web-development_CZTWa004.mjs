const id = "five-challenges-to-frontend-web-development.md";
						const collection = "posts";
						const slug = "five-challenges-to-frontend-web-development";
						...
						const data = {title:"Five Challenges to Frontend Web Development",description:"Let’s explore five of the most common challenges that frontend developers face and how to overcome them.",image:
						new Proxy({"src":"/_astro/five-challenges-to-frontend-web-development.s9J_DgNB.jpg","width":1920,"height":1280,"format":"jpg","fsPath":"C:/Users/St3vA/LevelUp/Engineer/astro/portfolio/src/content/posts/images/five-challenges-to-frontend-web-development.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/St3vA/LevelUp/Engineer/astro/portfolio/src/content/posts/images/five-challenges-to-frontend-web-development.jpg";
							}
							
							return target[name];
						}
					})
					,pubDate:new Date(1704585600000)};
						const _internal = {
							type: 'content',
							filePath: "C:/Users/St3vA/LevelUp/Engineer/astro/portfolio/src/content/posts/five-challenges-to-frontend-web-development.md",
							rawData: undefined,
						};
